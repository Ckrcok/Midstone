...
bool Wall::OnCreate()
{
	...
	if (id == 'w') {
		objShader = new Shader(nullptr, "shaders/defaultBlueVert.glsl", "shaders/defaultBlueFrag.glsl");
		//shader = new Shader(nullptr, "shaders/defaultVert.glsl", "shaders/defaultFrag.glsl");
	}
	else {
		objShader = new Shader(nullptr, "shaders/defaultVert.glsl", "shaders/defaultFrag.glsl");
