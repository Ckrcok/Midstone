...
//
//LightMesh::LightMesh(Component* parent_, const char* filename_) : Component(parent_) {
//	filename = filename_;
//}
//LightMesh::~LightMesh() {}
//
//bool LightMesh::OnCreate() {
//	LoadModel(filename);
...
//
//
//void LightMesh::LoadModel(const char* filename) {
...
//}
//
//void LightMesh::StoreMeshData(GLenum drawmode_) {
//	drawmode = drawmode_;
...
//}
//
//void LightMesh::Render() const {
//	glBindVertexArray(lightVao);
//	glDrawArrays(drawmode, 0, dateLength);
//	glBindVertexArray(0); // Unbind the VAO
//}
//
//void LightMesh::Render(GLenum drawmode_) const {
//	glBindVertexArray(lightVao);
//	glDrawArrays(drawmode_, 0, dateLength);
//	glBindVertexArray(0); // Unbind the VAO
//}
//
//void LightMesh::OnDestroy() {
//	glDeleteBuffers(1, &lightVbo);
//	glDeleteVertexArrays(1, &lightVbo);
//}
//
///// Currently unused.
//
//void LightMesh::Update(const float deltaTime) {}